...
export type FileDTO = {
  ...
  absolutePath: string;
  tags: ID[];
  /** When the file was imported into MetaTagger */
  dateAdded: Date;
  /** When the file was modified in MetaTagger, not related to OS modified date */
  dateModified: Date;
  /**
   * When the file was last indexed in MetaTagger: concerning the metadata and thumbnail.
