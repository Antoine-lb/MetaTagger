...
const handleMove = async (
  ...
  // If it's a file being dropped that's already in MetaTagger, move it
      ...
      if (isAcceptableType(event)) {
        ...
        try {
          ...
          if (matches) {
            ...
            // Otherwise it's an external file (e.g. from the web or a folder not set up as a Location in MetaTagger)
